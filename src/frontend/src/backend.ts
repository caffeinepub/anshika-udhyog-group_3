...
export class Backend implements backendInterface {
    ...
    async getMember(arg0: string): Promise<PublicMemberProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getMember(arg0);
                return from_candid_PublicMemberProfile_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPendingKycCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingKycCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listMembers(): Promise<Array<PublicMemberProfile>> {
        if (this.processError) {
            try {
    ...
    async saveMember(arg0: string, arg1: Member): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMember(arg0, await to_candid_Member_n27(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateKycStatus(arg0: string, arg1: T): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateKycStatus(arg0, to_candid_T_n29(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PublicMemberProfile_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublicMemberProfile): Promise<PublicMemberProfile> {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        memberId: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.memberId)),
        name: value.name,
        role: value.role
    };
}
...
async function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PublicMemberProfile>): Promise<Array<PublicMemberProfile>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PublicMemberProfile_n16(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Member_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Member): Promise<_Member> {
...
async function to_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        email: value.email,
        kycStatus: to_candid_T_n29(_uploadFile, _downloadFile, value.kycStatus),
        phone: value.phone,
        photo: await to_candid_ExternalBlob_n31(_uploadFile, _downloadFile, value.photo),
        amount: value.amount
    };
}
